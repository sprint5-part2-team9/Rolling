        ...
        <div className={styles.first}>
          ...
          <div>
            <p className={styles.firstTitle}>
              누구나 손쉽게, 온라인{" "}
              <span className={styles.firstTitle}>롤링 페이퍼를 만들 수 있어요</span>
            </p>
          </div>
          <div className={styles.description}>로그인 없이 자유롭게 만들어요.</div>
        </div>
        <div>
        ...
        <div className={styles.second}>
          ...
          <div>
            <p className={styles.secondTitle}>
              서로에게 이모지로 감정을 <span className={styles.secondTitle}>표현해보세요</span>
            </p>
          </div>
